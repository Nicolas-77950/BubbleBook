...
<div class="flex flex-col min-h-screen">
    <main class="flex-grow flex flex-col items-center mx-10">

        <!-- Premier tableau : Réservations en attente -->
        <h2 class="text-3xl font-bold text-center py-4">Réservations en attente</h2>
        ...
        <h2 class="text-3xl font-bold text-center py-4">Rendez-vous acceptés</h2>
