...
<body class="bg-gray-100 min-h-screen p-4 sm:p-6 lg:p-8">
    <div class="container mx-auto max-w-5xl bg-white rounded-lg shadow-md p-4 sm:p-6">
        ...
        <form method="GET" action="<?php echo $_SERVER['PHP_SELF']; ?>" class="space-y-4">
            ...
            <button type="submit" class="w-full bg-pink-500 text-white py-2 px-4 rounded-md hover:bg-pink-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-500 transition duration-300 ease-in-out transform hover:-translate-y-1">Rechercher</button>
        </form>
